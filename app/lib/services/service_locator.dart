...
import 'package:civilcops/services/complaint_services/report_complaint_service_impl.dart';
...
void setupServiceLocator() {
  ...
  serviceLocator.registerLazySingleton<ReportComplaintService>(() => ReportComplaintServiceImpl());
